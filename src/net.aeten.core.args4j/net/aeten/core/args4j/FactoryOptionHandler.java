 ...
 */
public class FactoryOptionHandler extends OptionHandler<Singleton<?>> {
	...
	public int parseArguments(Parameters params) throws CmdLineException {
		...
		try {
			...
			if ((configuration != null) && clazz.isAssignableFrom(Configurable.class)) {
				...
				Singleton<Configurable<String>> factory = new Singleton<Configurable<String>>((Class<Configurable<String>>)clazz, configuration);
				setter.addValue(factory);				
			} else {
				Singleton<?> factory = new Singleton<Object>(clazz);
				setter.addValue(factory);				
			}
