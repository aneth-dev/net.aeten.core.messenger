...
public interface MessengerAcknowledgeProtocol<Message, Acknowledge extends Enum<?>> {
	...
	/**
	 * @return acknowledge for given sent message with recieved ones or null if
	 *         recieved message does nt acknowledge sent one
	 */
	public Acknowledge getAcknowledge(Message sentMessage, Message recievedMessage);
}
