...
public class KnownKeysMap<K, V> extends AbstractKnownKeysMap<K, V> {
	private static final long serialVersionUID = 7581236987680272653L;
	private final Object[] values;
	private int size = 0;

	public KnownKeysMap(K[] keys, Factory<Integer, K> ordinal, final V initialValue) {
	...
	public KnownKeysMap(K[] keys, Factory<Integer, K> ordinal, Factory<V, ? super K> initialValue) {
		super(keys, ordinal);
	...
	public KnownKeysMap(K[] keys, Factory<Integer, K> ordinal) {
