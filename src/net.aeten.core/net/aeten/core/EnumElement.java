...
public abstract class EnumElement<T extends EnumElement<?>> implements Comparable<T> {

	private final int ordinal;
	private final String name;
	private final Class<?> type;

	protected EnumElement(int ordinal, String name) {
		this(null, ordinal, name);
	}
	protected EnumElement(Class<?> type, int ordinal, String name) {
		super();
	...
	public static class FactoryContext<T> {
		...
		public FactoryContext(T element, int ordinal, String name) {
	...
	public static class Generic<T> extends EnumElement<Generic<T>> {
		private final T element;

		private Generic(T element, int ordinal, String name) {
			super(ordinal, name);
			this.element = element;
		}
	...
	public static <T, E extends EnumElement<?>> E[] elements(T[] array, Factory<String, T> nameProvider, Factory<E, FactoryContext<T>> elementFactory) {
	...
	public static <T, E extends EnumElement<?>> E[] elements(Factory<E, FactoryContext<T>> elementFactory, final T... array) {
	...
	public static <T> Generic<T>[] genericEnum(Factory<String, T> nameProvider, T... array) {
