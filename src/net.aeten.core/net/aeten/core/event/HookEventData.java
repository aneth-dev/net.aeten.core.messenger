...
public class HookEventData<Source, E, H> extends EventData<Source, HookEvent<E, H>> {
	...
	public HookEventData(Source source, HookEvent<E, H> event, Priority priority) {
		this(source, event, priority, true);
	}

	public HookEventData(Source source, HookEvent<E, H> event, Priority priority, boolean doIt) {
		super(source, event, priority);
		this.doIt = doIt;
	}

	public HookEventData(Source source, HookEvent<E, H> event) {
