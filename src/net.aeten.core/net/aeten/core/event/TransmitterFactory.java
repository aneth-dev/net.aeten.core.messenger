...
public final class TransmitterFactory {
	...
	public static final <Event, Data extends EventData<?, Event>> TransmitterService<Event, Data> asynchronous(final String threadName, Event[] eventEnum, final Handler<Data> eventHandler, final Event... events) {
		return register(new AsynchronousTransmitter<Event, Data>(threadName, eventEnum), eventHandler, events);
	}

	public static final <Event, Data extends EventData<?, Event>> TransmitterService<Event, Data> asynchronous(final String threadName, final Event... events) {
		return new AsynchronousTransmitter<Event, Data>(threadName, events);
	}

	public static final <Data extends EventData<?, EnumElement.Generic<?>>> TransmitterService<EnumElement.Generic<?>, Data> asynchronous(final String threadName, final Handler<Data> eventHandler) {
