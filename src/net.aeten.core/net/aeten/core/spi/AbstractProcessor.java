...
public abstract class AbstractProcessor extends
	...
	public static PrintWriter getWriter (	FileObject fileObject,
														WriteMode mode,
	...
	public static BufferedReader getReader (FileObject fileObject)	throws FileNotFoundException,
	...
	protected static boolean annotationMirrorMatches (	TypeMirror annotation,
																		Class <? extends Annotation> annotationClass) {
	...
	protected static boolean annotationMirrorMatches (	AnnotationMirror annotation,
																		Class <? extends Annotation> annotationClass) {
		return annotationMirrorMatches (annotation.getAnnotationType (), annotationClass);
	}

	protected static boolean annotationMirrorMatches (	DeclaredType annotation,
																		Class <? extends Annotation> annotationClass) {
	...
	protected List <AnnotationMirror> getAnnotationMirrors (	Element element,
																				Class <? extends Annotation> annotationClass) {
	...
	protected static Collection <AnnotationValue> findValue (AnnotationMirror mirror,
																				String key) {
	...
	protected void debug (String message) {
		if (debug) processingEnv.getMessager ().printMessage (Kind.NOTE, message);
	}
	...
	protected static void writeImport (	PrintWriter writer,
													Class <?>... classes) {
	...
	protected TypeMirror mirror (	Class <?> type,
											Class <?>... parameterized) {
